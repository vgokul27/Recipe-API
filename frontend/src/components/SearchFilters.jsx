      ...
      >
        ...
        <div className="flex flex-wrap gap-3">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="px-6 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 cursor-pointer transition-colors font-medium shadow-md"
          >
            Search Recipes
          </motion.button>
          {hasActiveFilters && (
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="px-6 py-2 bg-gray-700 text-gray-200 rounded-lg hover:bg-gray-600 cursor-pointer transition-colors font-medium"
            >
              Clear Filters
            </motion.button>
          )}
